...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'organization.update': {
    ...
    key: 'org-details-updated',
    tenantPath: ['organization'],
    userPath: [],
  },
  'organization.delete': { roles: ['administrator'], key: 'org-deleted', tenantPath: ['organization'], userPath: [] },
  'user.delete': {
    roles: ['security-analyst'],
    key: 'security-analyst-removed',
...
const tenantRoles: string[] = ['administrator', 'security-analyst'];
