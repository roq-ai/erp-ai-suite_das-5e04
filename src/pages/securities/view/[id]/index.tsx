...
import { getSecurityById } from 'apiSdk/securities';
import { SecurityInterface } from 'interfaces/security';

function SecurityViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('security', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/securities/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Security Status" text={data?.security_status} />

                <FormListItem label="Security Score" text={data?.security_score} />
