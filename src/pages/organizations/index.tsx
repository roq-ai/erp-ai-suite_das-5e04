...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'configuration.count', 'data_privacy.count', 'landscape.count', 'security.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('configuration', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'configuration',
          header: 'Configuration',
          accessorKey: 'configuration',
          cell: ({ row: { original: record } }: any) => record?._count?.configuration,
        }
      : null,
    hasAccess('data_privacy', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'data_privacy',
          header: 'Data Privacy',
          accessorKey: 'data_privacy',
          cell: ({ row: { original: record } }: any) => record?._count?.data_privacy,
        }
      : null,
    hasAccess('landscape', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'landscape',
          header: 'Landscape',
          accessorKey: 'landscape',
          cell: ({ row: { original: record } }: any) => record?._count?.landscape,
        }
      : null,
    hasAccess('security', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'security',
          header: 'Security',
          accessorKey: 'security',
          cell: ({ row: { original: record } }: any) => record?._count?.security,
        }
      : null,
