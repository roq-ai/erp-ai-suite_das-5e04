...
import { getConfigurationById } from 'apiSdk/configurations';
import { ConfigurationInterface } from 'interfaces/configuration';

function ConfigurationViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('configuration', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/configurations/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Config Status" text={data?.config_status} />

                <FormListItem label="Config Score" text={data?.config_score} />
